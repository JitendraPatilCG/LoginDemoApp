...
2. Automatically detect parent branch of current branch and set base branch as parent branch:
   ...
   - If no parent branch is detected, ask the user to specify the base branch before creating the PR or you can list down the last 5 branches and ask the user to select one.
